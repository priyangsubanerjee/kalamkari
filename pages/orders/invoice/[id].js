    ...
    <>
      {invoice && (
        <div className="h-screen w-screen fixed inset-0 bg-neutral-100 flex justify-center overflow-auto lg:p-8">
          <div className="w-full lg:w-[600px] h-fit bg-white">
            <div className="lg:px-10 px-8 mt-10 flex items-center justify-between">
              ...
              <ReactToPdf targetRef={ref} filename="div-blue.pdf">
                {({ toPdf }) => (
                  <button
                    onClick={toPdf}
                    className="flex items-center bg-neutral-100 space-x-4 px-4 py-2 rounded text-sm"
                  >
                    <iconify-icon icon="fluent:print-16-filled"></iconify-icon>
                    <span>Print</span>
                  </button>
                )}
              </ReactToPdf>
            </div>
            <div ref={ref} className="lg:px-10 px-8 pt-10">
              <div className="">
